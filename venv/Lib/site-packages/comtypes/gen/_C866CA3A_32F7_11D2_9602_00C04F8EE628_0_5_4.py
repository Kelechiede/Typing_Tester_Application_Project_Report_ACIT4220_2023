...
__all__ = [
    'DISPID_SOTRemove', 'SpeechPropertyNormalConfidenceThreshold',
    'SpeechAddRemoveWord', 'DISPID_SRGState',
    'SPINTERFERENCE_NOSIGNAL', 'SpeechEmulationCompareFlags',
    'eLEXTYPE_PRIVATE19', 'SPWT_PRONUNCIATION', 'SAFTADPCM_8kHzMono',
    'DISPID_SLWsCount', 'SPPS_Modifier', 'DISPID_SRGetPropertyNumber',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet', 'SVEAudioLevel',
    'SFTInput', 'SAFTCCITT_ALaw_8kHzStereo', '_RemotableHandle',
    'SPWT_LEXICAL_NO_SPECIAL_CHARS', 'SVSFIsNotXML', 'ISpProperties',
    'SVF_Stressed', 'SPEI_TTS_BOOKMARK', 'DISPID_SLPs_NewEnum',
    'ISpNotifyTranslator', 'DISPID_SGRSAddRuleTransition',
    'ISpeechPhraseElement', 'SECLowConfidence', 'ISpNotifySink',
    'DISPID_SRCEFalseRecognition', 'eLEXTYPE_RESERVED9',
    'SpMMAudioIn', 'SPSERIALIZEDPHRASE',
    'DISPID_SVSLastStreamNumberQueued', 'DISPID_SPRsItem', 'SINone',
    'SREStreamEnd', 'ISpRecoGrammar', 'SPCS_ENABLED',
    'SAFT11kHz16BitStereo', 'DISPID_SVStatus', 'DISPID_SRCResume',
    ...
    'DISPID_SDKSetLongValue', 'SVPOver', 'DISPID_SOTCGetDataKey',
    'SPLO_STATIC', 'SPAS_CLOSED', 'DISPID_SGRSAddSpecialTransition',
    'SPPS_Interjection', 'SVEStartInputStream', 'DISPID_SGRsDynamic',
    'SpeechMicTraining', 'SVEAllEvents', 'SpeechTokenValueCLSID',
    'SAFT24kHz8BitMono', 'SAFT48kHz8BitMono', 'SSSPTRelativeToStart',
    'ISpRecoCategory', 'SWTAdded', 'SPRS_ACTIVE_WITH_AUTO_PAUSE',
    'DISPID_SpeechRecoContextEvents', 'SPEI_RECO_STATE_CHANGE',
    'DISPID_SOTsItem', 'ISpPhoneConverter', 'SRSInactive',
    'SPDKL_DefaultLocation', 'SPEI_RESERVED6', 'SAFT44kHz16BitMono',
    'SAFTDefault', 'SpeechVisemeFeature', 'DISPID_SRRGetXMLResult',
    'DISPID_SRCBookmark', 'DISPID_SpeechGrammarRuleStateTransitions',
    'DISPID_SABIEventBias', 'eLEXTYPE_VENDORLEXICON',
    'SPINTERFERENCE_TOOLOUD', 'SpeechRuleState',
    'ISpeechWaveFormatEx', 'DISPID_SGRSTNextState',
    'DISPID_SVSLastBookmark', 'STSF_CommonAppData',
    'DISPID_SRRAudioFormat', 'SPSMF_UPS',
    'DISPID_SRCERecognizerStateChange', 'SP_VISEME_16',
    'SPEI_PHRASE_START', 'DISPID_SLPPhoneIds', 'SPVPRIORITY',
    'eLEXTYPE_RESERVED10', 'SpeechAudioFormatGUIDText',
    'SVSFNLPSpeakPunc', '_ISpeechRecoContextEvents',
    'DISPID_SVGetProfiles', 'eLEXTYPE_MORPHOLOGY',
    'eLEXTYPE_PRIVATE13', 'DISPID_SPPName', 'SRARoot',
    'SpeechVoiceSkipTypeSentence', 'SVP_21', 'SVSFPurgeBeforeSpeak',
    'SRERecognition', 'SpCompressedLexicon', 'SGRSTTWildcard',
    'SpeechRecognizerState', 'SPADAPTATIONRELEVANCE',
    'SpeechRunState', 'DISPID_SpeechRecoContext',
    'SpInprocRecognizer', 'ISpGrammarBuilder', 'eLEXTYPE_PRIVATE11',
    'DISPID_SVSInputSentenceLength',
    'DISPID_SpeechPhraseReplacements', 'SRSEIsSpeaking',
    'eLEXTYPE_PRIVATE16', 'SGLexicalNoSpecialChars',
    'DISPID_SPPChildren', 'SRTSMLTimeout', 'DISPID_SPIRule',
    'DISPID_SPPEngineConfidence', 'DISPID_SRGCmdLoadFromMemory',
    'SPSERIALIZEDRESULT', 'SpeechInterference', 'SRADefaultToActive',
    'SRCS_Disabled', 'DISPID_SRRTStreamTime',
    'ISpeechGrammarRuleState', 'DISPID_SPEAudioSizeBytes',
    'DISPID_SOTCategory', 'SPDKL_CurrentConfig',
    'DISPID_SpeechPhraseElement', 'SAFTCCITT_uLaw_8kHzStereo',
    'SAFTCCITT_uLaw_11kHzStereo', 'DISPID_SPEPronunciation',
    'SPFM_CREATE_ALWAYS', 'DISPID_SPRuleName', 'SDTAlternates',
    'DISPID_SGRAddState', 'eLEXTYPE_PRIVATE12',
    'DISPID_SPERequiredConfidence', 'SP_VISEME_3',
    'DISPID_SRCEInterference', 'SLOStatic', 'SPRECOGNIZERSTATUS',
    'SPBO_PAUSE', 'SPINTERFERENCE_NOISE', 'DISPID_SRCEHypothesis',
    'DISPID_SPIGetText', 'SpeechPropertyResponseSpeed',
    'DISPID_SRGDictationSetState',
    'DISPID_SPANumberOfElementsInResult', 'SpeechFormatType',
    'SECFNoSpecialChars', 'DISPID_SGRSTsCount', 'SSSPTRelativeToEnd',
    'SWTDeleted', 'SAFTCCITT_uLaw_44kHzMono', 'ISpeechFileStream',
    'DISPID_SLGenerationId', 'DISPID_SGRSTPropertyValue',
    'DISPID_SRCState', 'SLTApp', 'DISPID_SRCERequestUI', 'SRAExport',
    'SGDisplay', 'SECHighConfidence', 'SPAS_STOP', 'SP_VISEME_13',
    'DISPID_SpeechLexiconWords', 'SpeechStreamFileMode', 'SVF_None',
    'SVSFParseMask', 'DISPID_SPRDisplayAttributes', 'SPAS_RUN',
    'SpeechDiscardType', 'SRESoundStart', 'SRADynamic', 'SPPS_Verb',
    'DISPID_SpeechWaveFormatEx', 'DISPID_SLWs_NewEnum',
    ...
    'DISPID_SGRSAddWordTransition', 'SVP_16', 'SpInProcRecoContext',
    'SpSharedRecognizer', 'DISPID_SPEsItem', 'SPEI_ADAPTATION',
    ...
    'SPRECOCONTEXTSTATUS', 'SVEWordBoundary', 'DISPID_SDKEnumKeys',
    'SP_VISEME_19', 'SPEI_INTERFERENCE',
    ...
    'DISPID_SRDisplayUI', 'IEnumSpObjectTokens', 'ISpeechLexiconWord',
    'eLEXTYPE_PRIVATE1', 'DISPID_SOTCEnumerateTokens', 'SVEViseme',
    'SBONone', 'DISPID_SVEWord', 'DISPID_SGRSTs_NewEnum',
    'DISPID_SLPsItem', 'SAFT11kHz8BitMono',
    'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE', 'SPWORDTYPE', 'SGDSActive',
    'DISPID_SRIsUISupported', 'DISPID_SPILanguageId',
    'SAFT48kHz16BitMono', 'SPRST_INACTIVE_WITH_PURGE',
    'DISPID_SPIEnginePrivateData', 'DISPID_SDKGetStringValue',
    'DISPID_SpeechMemoryStream', 'DISPID_SVPause',
    'DISPID_SpeechPhoneConverter',
    'SPINTERFERENCE_LATENCY_TRUNCATE_END', 'SASPause',
    'DISPID_SGRName', 'DISPID_SOTGetDescription', 'tagSPPROPERTYINFO',
    'SPLO_DYNAMIC', 'SPSHT_NotOverriden', 'SRTAutopause',
    'DISPID_SVSPhonemeId', 'DISPID_SLWType', 'DISPID_SMSADeviceId',
    'SRSEDone', 'SECNormalConfidence', 'SP_VISEME_7',
    'DISPID_SPPsCount', 'DISPID_SASCurrentSeekPosition',
    'ISpeechPhraseElements', 'SPEI_RESERVED5', 'SPRS_ACTIVE',
    'DISPID_SGRAttributes', 'SpObjectToken', 'DISPID_SRAudioInput',
    'SPSUnknown', 'SWPUnknownWordUnpronounceable',
    'DISPID_SPIReplacements', 'DISPID_SGRsItem', 'SGRSTTTextBuffer',
    'DISPID_SRGCmdSetRuleState', 'DISPID_SGRsFindRule',
    'ISpRecoContext', 'ISpObjectTokenCategory', 'SVPNormal',
    'ISpeechPhoneConverter', 'SVPAlert', 'SPPHRASEELEMENT',
    'SPXRO_SML', 'SPWORD', 'DISPID_SRCVoicePurgeEvent', 'SRSActive',
    'DISPID_SASFreeBufferSpace', 'SPEI_RESERVED2',
    'SAFTADPCM_11kHzMono', 'SPCT_SLEEP', 'DISPID_SpeechPhraseInfo',
    'SPSVerb', 'STSF_FlagCreate', 'SPXRO_Alternates_SML',
    'SAFT48kHz16BitStereo', 'SVP_14', 'DISPID_SOTsCount',
    'SAFT11kHz8BitStereo', 'SAFTGSM610_8kHzMono', 'DISPID_SVRate',
    'DISPID_SWFEChannels', 'DISPID_SPPId', 'ISpeechLexicon',
    'DISPID_SLPsCount', 'SpeechTokenContext', 'SECFIgnoreCase',
    'DISPID_SRGIsPronounceable', 'SRTExtendableParse',
    ...
    'SPFILEMODE', 'ISpVoice', 'DISPID_SPRuleFirstElement',
    'SITooFast', 'DISPIDSPRG', 'SRERequestUI',
    'DISPID_SpeechAudioStatus', 'DISPID_SDKSetBinaryValue', 'SPEVENT',
    'SPPS_Noncontent', 'SPPARTOFSPEECH', 'eLEXTYPE_LETTERTOSOUND',
    'SAFT8kHz16BitMono', 'DISPID_SRCEBookmark', 'SPAUDIOBUFFERINFO',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'DISPID_SPRules_NewEnum', 'DISPID_SPCLangId',
    'DISPID_SRGCmdLoadFromObject', 'SPEVENTSOURCEINFO',
    'SpObjectTokenCategory', 'SGLexical', 'SPGRAMMARSTATE',
    'ISpeechPhraseInfoBuilder', 'DISPID_SpeechBaseStream', 'SVP_20',
    'DISPID_SVSpeak', 'DISPID_SVSpeakCompleteEvent', 'SPSNoun',
    'SVP_11', 'DISPID_SRCERecognition', 'SVSFParseAutodetect',
    'tagSTATSTG', 'SVP_9', 'SpeechEngineProperties',
    'SpSharedRecoContext', 'DISPID_SPACommit', 'DISPID_SVEStreamEnd',
    ...
    'SpWaveFormatEx', 'DISPID_SpeechGrammarRuleState', 'SVP_0',
    'DISPID_SRGetRecognizers', 'SREBookmark', 'SPBOOKMARKOPTIONS',
    'SPSHORTCUTPAIRLIST', 'DISPID_SPIAudioSizeBytes',
    'SPINTERFERENCE', 'SAFTCCITT_uLaw_22kHzMono', 'eLEXTYPE_PRIVATE5',
    'SAFTNonStandardFormat', 'DISPID_SVGetAudioOutputs',
    'SPPS_NotOverriden', 'SpeechRecoEvents', 'SPEI_HYPOTHESIS',
    'DISPID_SLWLangId', 'SAFTADPCM_44kHzMono',
    'SAFTADPCM_11kHzStereo', 'DISPID_SREmulateRecognition',
    'DISPID_SDKDeleteValue', 'SpLexicon', 'ISpeechPhraseAlternates',
    'DISPID_SPRuleConfidence', 'SVP_15', 'SDTProperty',
    'DISPID_SRGCmdLoadFromResource', 'DISPID_SPPs_NewEnum',
    'DISPID_SWFEAvgBytesPerSec', 'SPEI_RECOGNITION',
    'DISPID_SVSLastResult', 'SVP_4', 'ISpeechRecoResult',
    'ISpPhoneticAlphabetSelection', 'SPFM_OPEN_READWRITE',
    'DISPID_SGRsAdd', 'ISpRecoContext2', 'DISPID_SBSWrite',
    'SPWAVEFORMATTYPE', 'eLEXTYPE_APP', 'SAFT24kHz8BitStereo',
    'eLEXTYPE_PRIVATE4', 'DISPID_SpeechGrammarRules',
    'DISPID_SpeechAudioFormat', 'SECFEmulateResult', 'SVP_1',
    'SAFT32kHz8BitMono', 'SPEI_TTS_PRIVATE', 'SPRST_ACTIVE_ALWAYS',
    'SP_VISEME_17', 'DISPID_SRGetFormat', 'ISpStream',
    'DISPID_SBSRead', 'SpeechVoiceSpeakFlags', 'SVESentenceBoundary',
    'SGSEnabled', 'DISPID_SRRPhraseInfo', 'SPEI_SR_AUDIO_LEVEL',
    'SPVPRI_NORMAL', 'SREAudioLevel', 'SSFMOpenReadWrite',
    'IInternetSecurityManager', 'DISPID_SGRSTType',
    'DISPID_SVEBookmark', 'SDTDisplayText', 'SPCATEGORYTYPE',
    'DISPID_SpeechPhraseBuilder', 'SVP_12', 'SAFTNoAssignedFormat',
    'DISPID_SPEDisplayAttributes', 'eLEXTYPE_PRIVATE8',
    'ISpEventSource', 'DISPID_SPEActualConfidence',
    'DISPID_SPAPhraseInfo', 'DISPID_SRCEStartStream',
    'SPRS_ACTIVE_USER_DELIMITED', 'DISPID_SDKDeleteKey',
    'SAFTCCITT_uLaw_22kHzStereo', 'SAFTADPCM_8kHzStereo', 'UINT_PTR',
    'eLEXTYPE_USER', 'ISpShortcut', 'ISpeechAudioFormat',
    'SpeechPropertyLowConfidenceThreshold', 'DISPID_SRGDictationLoad',
    'SREAdaptation', 'SPLEXICONTYPE', 'SGRSTTWord',
    'DISPID_SRCCreateGrammar', 'SPCT_SUB_COMMAND',
    'DISPID_SpeechPhraseElements', 'SpeechDisplayAttributes',
    'SREStreamStart', 'ISpXMLRecoResult', 'DISPID_SGRSTText',
    'DISPID_SPIAudioStreamPosition', 'DISPID_SRGId',
    'SpeechTokenShellFolder', 'SpNotifyTranslator',
    'DISPID_SGRsCount', 'SPDKL_LocalMachine', 'SSTTTextBuffer',
    ...
    'DISPID_SASNonBlockingIO', 'DISPID_SpeechRecoResult2',
    'DISPID_SLPPartOfSpeech', 'ISpeechPhraseReplacement',
    'SP_VISEME_12', 'SVSFUnusedFlags', 'SPWF_SRENGINE',
    'DISPID_SOTGetStorageFileName', 'DISPID_SABufferNotifySize',
    'DISPID_SpeechObjectTokens', 'DISPID_SpeechLexiconWord',
    'eLEXTYPE_PRIVATE17', 'ISpeechDataKey', 'SAFT16kHz8BitMono',
    'DISPID_SpeechGrammarRuleStateTransition', 'ISpSerializeState',
    'DISPID_SRSClsidEngine', 'SpeechLexiconType',
    'SpeechSpecialTransitionType', 'SPSEMANTICFORMAT',
    'eLEXTYPE_PRIVATE18', 'DISPID_SRGRules',
    'DISPID_SVSInputWordLength', 'SGDSInactive', 'SpResourceManager',
    'SPEI_END_INPUT_STREAM', 'DISPID_SRCEPropertyStringChange',
    'SREInterference', 'SRTReSent', 'SGRSTTDictation',
    ...
    'SDA_One_Trailing_Space', 'SVSFlagsAsync', 'DISPID_SOTCId',
    'SPSHORTCUTPAIR', 'ISpeechRecognizer', 'SGSDisabled',
    'DISPID_SVEStreamStart', 'DISPID_SpeechFileStream',
    'SREStateChange', 'DISPID_SPRuleId', 'SVEEndInputStream',
    'DISPID_SRSSupportedLanguages', 'SpeechCategoryAppLexicons',
    'DISPIDSPTSI_SelectionOffset', 'SPSEMANTICERRORINFO',
    'SECFIgnoreKanaType', 'Speech_Max_Pron_Length', 'ISpRecognizer2',
    ...
    'DISPID_SDKGetBinaryValue', 'eWORDTYPE_DELETED',
    'DISPID_SGRsCommit', 'SpeechPartOfSpeech', 'SPPS_RESERVED4',
    'DISPID_SPIStartTime', 'ISpeechObjectTokens', 'SPAUDIOSTATUS',
    'ISpRecoGrammar2', 'SREPhraseStart',
    'DISPID_SPEAudioStreamOffset', 'SpeechBookmarkOptions',
    'DISPID_SVSInputSentencePosition', 'SRESoundEnd',
    'DISPID_SGRSTPropertyName', 'DISPID_SAVolume',
    'ISpeechRecoResultDispatch', 'SVSFDefault', 'SP_VISEME_8',
    'SPAO_NONE', 'ISpeechRecognizerStatus', 'SVEPrivate',
    'ISpeechRecoResultTimes', 'DISPID_SAStatus',
    'DISPID_SMSAMMHandle', 'DISPID_SPIRetainedSizeBytes',
    'ISpStreamFormat', 'DISPID_SpeechVoiceStatus', 'SpMemoryStream',
    'SAFTCCITT_ALaw_11kHzStereo', 'SPEI_PHONEME',
    'SpeechAudioFormatType', 'DISPID_SpeechObjectTokenCategory',
    'SPGS_ENABLED', 'SVP_19', 'DISPID_SAEventHandle', 'ISpLexicon',
    'SPBO_TIME_UNITS', 'SPPHRASERULE', 'SAFT16kHz16BitMono',
    'STCInprocHandler', 'STCAll', 'eLEXTYPE_PRIVATE9',
    'SPWP_KNOWN_WORD_PRONOUNCEABLE', 'DISPID_SRRDiscardResultInfo',
    'ISpeechCustomStream', 'SREHypothesis', 'SAFT16kHz16BitStereo',
    'DISPID_SpeechRecoResult', 'DISPID_SPPConfidence',
    'DISPID_SRCPause', 'DISPID_SOTCSetId', 'SVP_13',
    'SDKLLocalMachine', 'DISPID_SpeechDataKey', 'ISpeechBaseStream',
    'SP_VISEME_5', 'SPPS_LMA', 'ISpeechTextSelectionInformation',
    'DISPID_SRCEEnginePrivate', 'DISPID_SPEAudioTimeOffset',
    'SREPrivate', 'SpeechTokenKeyAttributes', 'STCInprocServer',
    'SRAORetainAudio', 'SAFTExtendedAudioFormat', 'SPEI_UNDEFINED',
    '__MIDL___MIDL_itf_sapi_0000_0020_0002', 'ISpRecognizer3',
    'SpeechVoiceEvents', 'SAFT24kHz16BitMono', 'SLODynamic',
    'SPWORDPRONUNCIATIONLIST', 'DISPID_SBSSeek', 'ISpeechGrammarRule',
    'DISPID_SVAlertBoundary', 'SpAudioFormat',
    'DISPID_SPRuleEngineConfidence', 'DISPID_SPISaveToMemory',
    'SpStreamFormatConverter', 'SpeechCategoryRecognizers',
    'SpNullPhoneConverter', 'DISPID_SVEventInterests',
    'DISPID_SRCRetainedAudio', 'SP_VISEME_2', 'SAFT22kHz16BitStereo',
    'DISPID_SOTDisplayUI', 'DISPID_SRStatus', 'DISPID_SRCRecognizer',
    'SpMMAudioOut', 'SpeechTokenIdUserLexicon',
    'SpeechDictationTopicSpelling',
    'DISPID_SPPBRestorePhraseFromMemory', 'SPAO_RETAIN_AUDIO',
    'DISPID_SPIGrammarId', 'DISPID_SRGetPropertyString',
    'SpeechRuleAttributes', 'SPEI_PROPERTY_NUM_CHANGE',
    'SPRST_ACTIVE', 'ISpeechLexiconPronunciation',
    'DISPID_SMSSetData', 'SPEI_MIN_TTS', 'DISPID_SRIsShared',
    'DISPID_SPRText', 'ISpRecoResult', 'SAFT12kHz8BitStereo',
    'SPRECORESULTTIMES', 'DISPID_SVSpeakStream', 'eLEXTYPE_PRIVATE6',
    'SPAR_Unknown', 'SVP_18', 'ISpStreamFormatConverter',
    'SVSFIsFilename', 'DISPID_SPCPhoneToId', 'SVSFParseSsml',
    'SpeechRegistryLocalMachineRoot', 'SP_VISEME_4', 'SPSFunction',
    'SPVPRI_OVER', 'SDKLDefaultLocation', 'SGPronounciation',
    'DISPID_SAFSetWaveFormatEx', 'DISPID_SOTIsUISupported',
    'SpPhoneticAlphabetConverter', 'SAFT11kHz16BitMono',
    'SpeechDataKeyLocation', 'DISPID_SVEPhoneme', 'SpeechAudioState',
    'DISPID_SOTRemoveStorageFileName', 'ISpDataKey', 'SSTTWildcard',
    'DISPID_SGRSTWeight', 'DISPID_SRRAlternates', 'DISPID_SRRAudio',
    'SPWT_LEXICAL', 'SPINTERFERENCE_TOOSLOW', 'SAFTADPCM_22kHzMono',
    'SPSModifier', 'SSFMCreateForWrite',
    'SpeechCategoryPhoneConverters', 'SpeechAllElements',
    'DISPID_SRCESoundStart', 'SpeechAudioProperties',
    'DISPID_SPRsCount', 'SAFTADPCM_44kHzStereo',
    'ISpeechPhraseProperty', 'DISPID_SPRNumberOfElements',
    'SPWT_DISPLAY', 'SREPropertyStringChange', 'SPPS_Function',
    'DISPID_SVSkip', 'SpMMAudioEnum', 'DISPID_SRCEAdaptation',
    'SPWORDPRONOUNCEABLE', 'SVEPhoneme', 'SPVPRI_ALERT',
    'DISPID_SAFGetWaveFormatEx', 'SRTEmulated',
    'DISPID_SGRAddResource', 'STCLocalServer', 'SINoSignal',
    'SPPS_Unknown', 'SPEI_MAX_TTS', 'eLEXTYPE_PRIVATE10',
    'DISPID_SRProfile', 'SBOPause', 'SpeechGrammarWordType',
    'ISpeechObjectTokenCategory', '_SPAUDIOSTATE',
    'SpeechEngineConfidence', 'SpeechPropertyResourceUsage',
    'DISPID_SPAsCount', 'ISpeechRecoGrammar', 'DISPID_SWFEBlockAlign',
    'SPEI_START_INPUT_STREAM', 'DISPID_SpeechLexiconProns',
    'SDKLCurrentConfig', 'SpFileStream', 'DISPID_SVEVoiceChange',
    'DISPID_SpeechRecognizer', 'DISPID_SPRulesItem', 'SSFMCreate',
    'eLEXTYPE_PRIVATE20', 'DISPID_SRCEventInterests',
    'DISPID_SDKCreateKey', 'ISpeechPhraseRules',
    'DISPID_SpeechPhraseProperty', 'DISPID_SFSClose',
    'SpUnCompressedLexicon', 'DISPID_SPERetainedSizeBytes',
    'DISPID_SLPType', 'SPCT_SUB_DICTATION', 'eLEXTYPE_PRIVATE7',
    'SpeechGrammarState', 'SpPhoneConverter', 'SpeechCategoryVoices',
    'SRAInterpreter', 'DISPID_SRRGetXMLErrorInfo',
    'SpeechAudioVolume', 'SPPHRASEREPLACEMENT',
    'DISPID_SRSAudioStatus', 'SP_VISEME_0', 'SPSHT_Unknown',
    'DISPID_SpeechRecognizerStatus', 'eLEXTYPE_PRIVATE14',
    'ISpeechMMSysAudio', 'ISpObjectToken', 'SpeechWordType',
    ...
    'ISpeechPhraseProperties', 'ISpEventSink', 'SPGS_DISABLED',
    'SPSNotOverriden', 'SAFT32kHz16BitMono', 'SVP_8',
    'DISPID_SRAudioInputStream', 'DISPID_SRGSetWordSequenceData',
    'SP_VISEME_15', 'eLEXTYPE_PRIVATE2', 'DISPID_SPPsItem',
    'DISPID_SWFEBitsPerSample', 'SPRULE', 'DISPID_SPEsCount',
    'SPEI_ACTIVE_CATEGORY_CHANGED', 'SpeechCategoryAudioIn',
    'DISPID_SRGDictationUnload', 'SASClosed',
    'SAFTCCITT_ALaw_44kHzMono', 'ISpeechXMLRecoResult',
    'DISPID_SDKOpenKey', 'DISPID_SpeechLexiconPronunciation',
    'DISPID_SRSNumberOfActiveRules', 'SRATopLevel', 'SITooLoud',
    'DISPID_SRCRequestedUIType', 'SPAUDIOOPTIONS',
    'DISPID_SGRInitialState', 'SPCT_COMMAND', 'SPEI_SR_PRIVATE',
    'DISPID_SPRuleNumberOfElements', 'DISPID_SADefaultFormat',
    'SPGS_EXCLUSIVE', 'SAFT8kHz16BitStereo', 'DISPID_SDKGetlongValue',
    'SpeechRecoContextState', 'SPBO_AHEAD',
    'DISPID_SLAddPronunciation', 'ISpPhoneticAlphabetConverter',
    'SFTSREngine', 'SREFalseRecognition',
    'DISPID_SRCreateRecoContext', 'SRCS_Enabled',
    'SpPhraseInfoBuilder', 'DISPID_SVGetAudioInputs',
    'SAFTCCITT_ALaw_44kHzStereo', 'SPSTREAMFORMATTYPE',
    'DISPIDSPTSI_ActiveOffset', 'DISPID_SVSVisemeId',
    'DISPID_SOTSetId', 'DISPID_SGRSTsItem', 'DISPID_SASState',
    'SpeechGrammarTagDictation', 'SSFMOpenForRead', 'SVEBookmark',
    'SPDATAKEYLOCATION', 'SpShortcut', 'STSF_LocalAppData',
    'SDTLexicalForm', 'DISPID_SLGetWords',
    'DISPID_SLRemovePronunciation', 'DISPID_SpeechPhraseAlternates',
    'SPWORDLIST', 'SECFIgnoreWidth', 'DISPID_SRCSetAdaptationData',
    'DISPID_SPPParent', 'DISPID_SPRs_NewEnum', 'DISPID_SPIEngineId',
    'eWORDTYPE_ADDED', 'ISpeechLexiconWords', 'SPAR_Medium',
    'DISPID_SVEEnginePrivate', 'DISPID_SVSyncronousSpeakTimeout',
    'DISPID_SpeechPhraseProperties', 'SRTStandard', 'SSTTDictation',
    '_ISpeechVoiceEvents', 'DISPID_SRCEAudioLevel', 'SREAllEvents',
    ...
    'DISPID_SPRFirstElement', 'ISpeechGrammarRuleStateTransition',
    'SpeechPropertyHighConfidenceThreshold', 'DISPID_SCSBaseStream',
    'DISPID_SABIMinNotification', 'SAFTText', 'DISPID_SLWWord',
    'SAFTGSM610_44kHzMono', 'ISpPhrase', 'eLEXTYPE_RESERVED6',
    'ISpeechAudioStatus', 'DISPID_SGRClear', 'SAFT44kHz8BitMono',
    'SPTEXTSELECTIONINFO', 'SPRECOSTATE', 'DISPID_SVEViseme',
    'DISPID_SLAddPronunciationByPhoneIds', 'DISPID_SLWsItem',
    'ISpeechPhraseInfo', 'DISPID_SRCESoundEnd', 'SPPROPERTYINFO',
    'SP_VISEME_18', 'DISPID_SpeechObjectToken', 'SGRSTTEpsilon',
    'SPRULESTATE', 'DISPID_SVPriority', 'SpeechVoiceCategoryTTSRate',
    'DISPID_SPEs_NewEnum', 'DISPID_SABufferInfo',
    'SpeechUserTraining', 'SPSSuppressWord',
    'DISPID_SRRSetTextFeedback', 'DISPID_SLGetGenerationChange',
    'SPEI_SOUND_START', 'DISPID_SPIElements',
    'DISPID_SRCEPropertyNumberChange', 'DISPID_SOTId',
    'DISPID_SRCCreateResultFromMemory', 'SPEI_RESERVED3',
    'SPEI_MIN_SR', 'eLEXTYPE_RESERVED4', 'SPPHRASE', 'DISPID_SFSOpen',
    'DISPID_SWFEExtraData', 'SpStream', 'DISPID_SDKEnumValues',
    'SPSInterjection', 'DISPID_SOTs_NewEnum', 'Speech_Default_Weight',
    'DISPID_SpeechPhraseReplacement', 'SITooSlow',
    'IInternetSecurityMgrSite', 'DISPID_SPAStartElementInResult',
    'SLTUser', 'SWPUnknownWordPronounceable', 'DISPID_SPAsItem',
    'DISPID_SGRsCommitAndSave', 'SPLOADOPTIONS',
    'ISpeechMemoryStream', 'WAVEFORMATEX', 'SVEVoiceChange',
    'SAFTCCITT_uLaw_11kHzMono', 'SpeechTokenKeyUI',
    'SAFTCCITT_ALaw_22kHzStereo', 'SPSLMA', 'SVP_6',
    'DISPID_SPARecoResult', 'DISPID_SVESentenceBoundary',
    'SPXMLRESULTOPTIONS', 'DISPID_SRCEPhraseStart', 'SDKLCurrentUser',
    'DISPIDSPTSI_SelectionLength', 'SPAR_High',
    'SpeechAudioFormatGUIDWave', 'SpeechRetainedAudioOptions',
    'DISPID_SpeechPhraseRule', 'DISPID_SOTGetAttribute', 'SVP_5',
    'LONG_PTR', 'SpeechPropertyComplexResponseSpeed',
    'DISPID_SOTCDefault', 'SPEI_END_SR_STREAM', 'DISPID_SVVoice',
    'SPBINARYGRAMMAR', 'SPEI_START_SR_STREAM', 'DISPID_SGRId',
    'SDA_Consume_Leading_Spaces', 'SRSInactiveWithPurge',
    'Speech_Max_Word_Length', 'ISpeechAudio', 'DISPID_SpeechAudio',
    'SPEI_SOUND_END', 'SASStop', 'SpeechRecognitionType',
    'ISpPhraseAlt', 'SVSFParseSapi', 'SPBO_NONE',
    'SAFTGSM610_22kHzMono', 'DISPID_SVIsUISupported',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet', 'IStream', 'SVP_3',
    'DISPID_SPPNumberOfElements', 'IEnumString',
    'SAFTADPCM_22kHzStereo', 'DISPID_SpeechMMSysAudio',
    'ISpeechVoice', 'DISPID_SGRs_NewEnum', 'DISPID_SGRSTRule',
    'SPFM_CREATE', 'SVF_Emphasis', 'SpCustomStream',
    'DISPID_SABIBufferSize', 'SP_VISEME_1', 'SDA_No_Trailing_Space',
    'DISPID_SRCCmdMaxAlternates', 'DISPID_SRRRecoContext',
    'SpeechLoadOption', 'SRAONone', 'SPSMF_SAPI_PROPERTIES',
    'DISPID_SRRSpeakAudio', 'SDA_Two_Trailing_Spaces',
    'SPEI_SR_RETAINEDAUDIO', 'DISPID_SRRTTickCount',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_MS', 'SPPS_SuppressWord',
    'SAFT24kHz16BitStereo', 'SDTAll', 'SPEI_SR_BOOKMARK',
    'SAFTTrueSpeech_8kHz1BitMono', 'SECFDefault', 'SVP_7',
    'SDTReplacement', 'SAFT22kHz8BitStereo', 'DISPID_SAFType',
    'DISPID_SVSRunningState', 'SPEI_REQUEST_UI',
    'SpeechVoicePriority', 'SPAUDIOSTATE', 'SPEI_SENTENCE_BOUNDARY',
    'DISPID_SPIAudioSizeTime', 'SP_VISEME_9', 'DISPID_SPRuleChildren',
    'SPEI_RESERVED1', 'SITooQuiet', 'ISpeechAudioBufferInfo',
    'SVSFNLPMask', 'SP_VISEME_6', 'SAFTCCITT_uLaw_44kHzStereo',
    'SPPHRASEPROPERTY', 'DISPID_SGRSRule', 'SREPropertyNumChange',
    'SP_VISEME_20', 'DISPID_SPAs_NewEnum', 'DISPIDSPTSI',
    'SAFTCCITT_ALaw_8kHzMono', 'DISPID_SPPFirstElement',
    'SpeechVisemeType', 'SGDSActiveUserDelimited', 'SPWF_INPUT',
    'ISpRecognizer', 'SPPS_Noun', 'SPEVENTENUM',
    'SAFTCCITT_ALaw_22kHzMono', 'DISPID_SPCIdToPhone',
    'SpeechStreamSeekPositionType', 'SDTRule', 'DISPID_SPRuleParent',
    'SP_VISEME_14', 'ISpeechLexiconPronunciations',
    'DISPID_SPEDisplayText', 'DISPID_SRGReset', 'SPSHT_EMAIL',
    'ISpeechRecoContext', 'SPEI_WORD_BOUNDARY', 'ISpeechGrammarRules',
    'DISPID_SLRemovePronunciationByPhoneIds',
    'SPEI_FALSE_RECOGNITION', 'DISPID_SASetState', 'SVP_17',
    'DISPID_SpeechVoiceEvent', 'SPINTERFERENCE_LATENCY_WARNING',
    'DISPID_SLWPronunciations', 'DISPID_SRGSetTextSelection',
    'SpeechWordPronounceable', 'DISPID_SVDisplayUI',
    'SPFM_OPEN_READONLY', 'DISPID_SRCVoice', 'ISpeechRecoResult2',
    ...
    'Speech_StreamPos_RealTime', 'SpVoice', 'SAFT22kHz8BitMono',
    'STCRemoteServer', 'SASRun', 'DISPID_SRGCmdSetRuleIdState',
    'SPCONTEXTSTATE', 'SP_VISEME_11', 'DISPID_SVAudioOutput',
    'Speech_StreamPos_Asap', 'SP_VISEME_21', 'SDTAudio',
    ...
    'ISequentialStream', 'DISPID_SVGetVoices',
    'tagSPTEXTSELECTIONINFO', 'SpeechRecoProfileProperties',
    'ISpMMSysAudio', 'SPAR_Low', 'SPCT_DICTATION',
    'eLEXTYPE_RESERVED8', 'eLEXTYPE_PRIVATE15',
    'DISPID_SOTMatchesAttributes', '__MIDL_IWinTypes_0009',
    'SRERecoOtherContext', 'SPVISEMES', 'DISPID_SVResume',
    'DISPID_SpeechPhraseRules', 'SPSHT_OTHER', 'SRSActiveAlways',
    'STSF_AppData', 'SPEI_VISEME',
    'ISpeechGrammarRuleStateTransitions', 'DISPID_SWFESamplesPerSec',
    'SAFT44kHz8BitStereo', 'SINoise', 'DISPID_SMSGetData',
    'DISPID_SVAudioOutputStream', 'SP_VISEME_10',
    'eLEXTYPE_RESERVED7', 'DISPID_SPELexicalForm', 'DISPID_SAFGuid',
    'SDTPronunciation', 'SVSFPersistXML',
    'SPWP_UNKNOWN_WORD_PRONOUNCEABLE', 'SPEI_MAX_SR',
    'SAFT8kHz8BitMono', 'DISPID_SVSLastBookmarkId', 'SVSFIsXML',
    'SPWORDPRONUNCIATION', 'DISPID_SpeechRecoResultTimes', 'SVP_10',
    'DISPID_SRRTimes', 'SAFT12kHz16BitStereo', 'SAFT48kHz8BitStereo',
    'SpeechCategoryRecoProfiles', 'SPDKL_CurrentUser',
    'ISpeechResourceLoader', 'SPRS_INACTIVE', 'DISPID_SOTDataKey',
    'DISPID_SRGRecoContext', 'SPRST_NUM_STATES', 'DISPID_SBSFormat',
    'SRAImport', 'SpeechCategoryAudioOut', 'ISpeechObjectToken',
    'DISPID_SRState', 'eLEXTYPE_USER_SHORTCUT', 'DISPID_SpeechVoice',
    'DISPID_SPIProperties', 'SpeechPropertyAdaptationOn',
    'SPPS_RESERVED2'
]

_check_version('1.2.0', 1633527515.941447)
